-- Extend provider-aware opening broadcast audit rows with partial failure
-- information. This is additive because the original provider audit migration
-- may already be applied in deployed Supabase projects.
...
begin
  ...
  values (
    ...
    pg_catalog.jsonb_build_object(
      ...
      'failure_reasons', coalesce(failure_reasons, array[]::text[])
    )
  );
end;
$$;

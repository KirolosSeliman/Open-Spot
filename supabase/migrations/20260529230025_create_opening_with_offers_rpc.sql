-- Create openings, prepared offers, and audit logs in one authorized database transaction.
-- This keeps audit_logs protected from direct client inserts while allowing the
-- dashboard opening workflow to write an auditable event safely.

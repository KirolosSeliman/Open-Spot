-- Public waitlist signup write path.
-- The browser still has no table grants; writes go through this controlled RPC
-- called by the Next.js route handler with the anon key.

...
export function InsightsFiltersBar({
  ...
  return (
    <section className="min-w-0 rounded-[18px] border border-[#e2e8f0] bg-white p-4 shadow-[0_8px_30px_rgba(15,23,42,0.04)] sm:p-5">
      <div className="flex min-w-0 flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        ...
        <div className="grid min-w-0 w-full grid-cols-1 gap-3 sm:flex-row sm:flex-wrap sm:items-center md:grid-cols-none md:flex">
          ...
          <label className="grid min-w-0 gap-1.5 sm:flex-1">
            ...
            <select
              aria-label="Service"
              className="min-h-11 w-full min-w-0 rounded-xl border border-[#e2e8f0] bg-[#f8fafc] px-3 text-sm font-medium text-[#07142f]"
          ...
          <div className="inline-flex min-h-11 w-full min-w-0 items-center gap-2 rounded-xl border border-[#e2e8f0] bg-[#f8fafc] px-3 text-sm font-medium text-[#475569] sm:w-auto">
            <svg
              aria-hidden="true"
            ...
            <span className="min-w-0 break-words">{periodWindow.dateRangeLabel}</span>
          </div>
        </div>
      </div>
    </section>

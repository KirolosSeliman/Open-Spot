    ...
    <div className="grid gap-4 lg:grid-cols-3">
      ...
      >
        <div className="grid gap-3">
          ...
          <label className="grid min-h-40 cursor-pointer place-items-center rounded-2xl border border-dashed border-[var(--primary)] bg-[#f3faf7] p-5 text-center text-sm font-bold text-[var(--primary-strong)]">
          ...
          <button
            className="min-h-11 rounded-full bg-[var(--primary)] px-5 text-sm font-black text-white disabled:cursor-not-allowed disabled:opacity-50"
      ...
      <section className="rounded-2xl border border-[var(--line)] bg-white p-4">
        ...
        <a
          className="mt-5 inline-flex min-h-11 items-center rounded-full bg-[var(--primary)] px-5 text-sm font-black text-white"

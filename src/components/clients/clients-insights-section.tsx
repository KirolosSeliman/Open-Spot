    ...
    <section className="grid gap-4 xl:grid-cols-2">
      ...
      <div className="rounded-[16px] border border-[#e2e8f0] bg-white p-5 shadow-[0_8px_30px_rgba(15,23,42,0.04)]">
        <div className="mb-4 flex items-center justify-between gap-3">
          ...
          <span className="inline-flex shrink-0 items-center gap-1.5 rounded-full border border-[#e2e8f0] bg-[#f8fafc] px-3 py-1.5 text-xs font-semibold text-[#64748b]">
            30 derniers jours
            <svg
              aria-hidden="true"
        ...
        <ClientsGrowthChart series={insights.growthSeries} />
      </div>

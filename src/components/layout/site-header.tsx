      ...
      <div className="flex items-center justify-between gap-3 md:flex-wrap">
        ...
        <div className="flex shrink-0 items-center gap-2 md:order-3">
          {isSignedIn ? (
            <>
              <Link
                className="hidden rounded-full border border-[var(--line)] bg-white px-3 py-2 text-sm font-bold text-[var(--foreground)] transition hover:bg-slate-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--primary)] md:inline-flex"
                href="/dashboard"
              >
                {t.auth.dashboard}
              </Link>
              <form action={signOutAction}>
                <button
                  className="hidden rounded-full px-3 py-2 text-sm font-bold text-[var(--muted)] transition hover:bg-slate-100 hover:text-[var(--foreground)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--primary)] md:inline-flex"
                  type="submit"
                >
                  {t.auth.signOut}
                </button>
            ...
            <>
              ...
              <Link
                className="hidden rounded-full bg-[var(--primary)] px-3 py-2 text-sm font-black text-white shadow-[0_12px_24px_rgba(79,125,243,0.22)] transition hover:bg-[var(--primary-strong)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--primary)] md:inline-flex"
                href="/signup"
              >

...
function KpiCard({
  ...
  return (
    <article className="flex min-h-[132px] flex-col rounded-[20px] border border-[#e3eaf5] bg-white p-5 shadow-[0_18px_50px_rgba(15,23,42,0.06)]">
      ...
      <p className="mt-2.5 text-[13px] leading-5 text-[#64748b]">{sublabel}</p>
    </article>
  );
}

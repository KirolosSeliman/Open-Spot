    ...
    Tables: {
      ...
      customer_sms_preferences: {
        Row: {
          ...
          organization_id: string;
          customer_id: string;
          sms_consent_status: Database["public"]["Enums"]["sms_consent_status"] | null;
          consented_at: string | null;
          consent_source: string | null;
          opted_out_at: string | null;
          opt_out_source: string | null;
          manual_send_mode: string;
          manual_snooze_until: string | null;
          notes: string | null;
          created_at: string;
          updated_at: string;
        };
      ...
      organization_settings: {
        Row: {
          ...
          cooldown_after_completed_appointment_days: number;
          cooldown_after_filled_spot_days: number;
          max_sms_per_day: number;
          max_sms_per_7_days: number;
          max_sms_per_30_days: number;
          block_if_future_appointment_exists: boolean;
          future_appointment_window_days: number;
          allowed_send_start_time: string;
          allowed_send_end_time: string;
          always_review_recipients_before_send: boolean;
          created_at: string;
          updated_at: string;
        };
        Insert: {

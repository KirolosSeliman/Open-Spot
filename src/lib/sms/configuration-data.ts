...
export function deriveSmsActivationPrerequisites({
  ...
  const onboardingComplete =
    organizationReadiness.onboardingStatus === "completed" ||
    organizationReadiness.onboardingStatus === null;

  const billingPaid = organizationReadiness.billingStatus === "paid";
  ...
  return [
    ...
    },
    {
      ...
      label: onboardingComplete
        ? "Configuration entreprise validée"
        : "Onboarding complété",
      description: "Informations et documents reçus",
      status: onboardingComplete ? "validated" : "missing"
    },
    {
      key: "billing",
      label: "Statut de facturation payé",
      description: "Compte Twilio en règle",
      status: billingPaid ? "validated" : "pending"
    },
    {
      key: "sms_active",
